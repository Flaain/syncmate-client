...
export const ProfileMenuSkeleton = () => (
    <>
        <div className='px-4 pt-4 flex flex-col relative'>
            <PreAnimatedSkeleton className='size-32 rounded-full self-center bg-primary-dark-50 mb-5' />
            <PreAnimatedSkeleton className='py-2 px-4 h-14 rounded-lg bg-primary-dark-50 mb-5' />
            <PreAnimatedSkeleton className='py-2 px-4 h-14 rounded-lg bg-primary-dark-50 mb-5' />
            <PreAnimatedSkeleton className='py-2 px-4 h-14 rounded-lg bg-primary-dark-50' />
        </div>
        ...
        <PreAnimatedSkeleton className='flex w-[calc(100%-32px)] py-2 px-4 h-14 rounded-lg bg-primary-dark-50 m-4' />
        <SidebarMenuSeparator className='h-auto'>
