...
export const conversationApi = {
    ...
    getPreviousMessages: (recipientId: string, cursor: string, signal?: AbortSignal) => api.get<Pick<Conversation, 'messages'>>(`/conversation/previous-messages/${recipientId}`, { params: { cursor }, signal }),
